...
public class Inventory {
    ...
    /**
     * Create an Inventory that is a view of `copy`. The held "stock" of the
     * resulting
     * Inventory will be references to the instances referred to by the `copy`
     * constructor.
     * 
     * @param copy
     */
    ...
    public Optional<ItemInterface> removeOne(String itemName) {
        Integer removeFromIdx = indexOfItemByName(itemName);
        if (removeFromIdx == ITEM_NOT_FOUND) {
            return Optional.empty();
        }

        return Optional.of(stock.remove(removeFromIdx.intValue()));
    }
